layui.define(['jquery', 'laytpl', 'layer'], function (e) {
    ...
    job.prototype.config = {
        ...
        time_limit: 500,
        pullTimer: null,
        data: {content:[{consignee:'测试',phone_number:'123423'}]},
        temp_data: {},
        params: {},
        filter: '',
        method: 'get',
...
// 修改 使用本地数据 start
//         var data = [{consignee:'测试',phone_number:'123423'}];
//         _self.handles.setData(data);
        // 修改 使用本地数据 end
        // todo
        ...
        $.ajax($.extend({
           ...
           // data: $.extend({[_config.request.keywords]: _config.filter, t: new Date().getTime()}, _config.params),
            ...
            success: function (resp) {
                resp = {content:[{consignee:'测试',phone_number:'123423'}]}
                console.log("test2")
